...
namespace ClassLibrary
{
    ...
    public class OffroadCar : Transport
    {
        ...
        public new OffroadCar Clone()
        {
            return new OffroadCar(this.ID.Id, Brand, Year, Colour, Cost, Clearance, AllWheelDrive, OffroadType);
        }
        ...
        {
            get => new Transport(this.ID.Id, this.Brand, this.Year, this.Colour, this.Cost, this.Clearance);
        }
    }
}